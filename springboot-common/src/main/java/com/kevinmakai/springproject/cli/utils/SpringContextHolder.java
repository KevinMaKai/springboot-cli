package com.kevinmakai.springproject.cli.utils;
 ...
 * <p></p>
 * Created by  kevin on 2016/08/02.
 */
public class SpringContextHolder implements ApplicationContextAware, DisposableBean {
    ...
    private static void assertContextInjected() {
        Validate.validState(applicationContext != null, "applicaitonContext属性未注入, 请在Spring配置文件中定义SpringContextHolder.");
    }
}
